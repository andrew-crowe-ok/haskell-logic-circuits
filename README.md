...
The goal is to build a computer from first principles. This simulation implements addition arithmetic at the hardware level:
...
<img width="854" height="797" alt="image" src="https://github.com/user-attachments/assets/1cc047ab-b675-4497-b901-cb6f2f0bc16f" />
...
Clone the repository and run the application using Cabal:
 ...
 `
git clone https://github.com/andrew-crowe-ok/logic-sim.git
cd logic-sim
cabal run logic-sim
 `  
*Note: Ensure your terminal window is at least 80x40 characters, or the program will halt the boot process to prevent rendering errors.*
